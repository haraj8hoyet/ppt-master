...
class Config:
    ...
    # Increased default to 20 slides — I usually need more room for detailed presentations
    max_slides: int = field(default_factory=lambda: int(os.getenv("MAX_SLIDES", "20")))
    default_theme: str = field(default_factory=lambda: os.getenv("DEFAULT_THEME", "light"))
